...
def SIRsimulation(N, table_n_star,
    ...
    file_log.flush()
    print('S, I, R, Q, SQ, total_tested_individual, positive_results, number_of_total_tests, n_star, number_of_group_tests, TP,TN,FP,FN', file=file_log)
    ...
    for t in range(tmax):
        ...
        # step 2. do test
        test_result, number_of_total_tests, number_of_group_tests, TP,TN,FP,FN = group_test(
                              trajs,n_star,daily_test_cap=round_daily_test_cap, test_policy=test_policy)
