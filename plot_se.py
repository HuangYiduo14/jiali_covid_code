...
ax11.plot(se_up_antigen['p'],se_up_antigen['sep1_lws'],label='antigen',color = 'k')
for n in n_list:
    ax11.plot(se_up_pcr['p'],se_up_pcr['sep'+str(n)+'_lws'],label='PCR n='+str(n),color=cmap[n])
...
ax12.plot(se_up_antigen['p'],se_up_antigen['sed1_lws'],label='antigen',color = 'k')
for n in n_list:
    ax12.plot(se_up_pcr['p'], se_up_pcr['sed'+str(n) + '_lws'], label='PCR n='+str(n),color=cmap[n])
ax12.set_xscale('log')
